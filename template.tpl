...

{
  ...
  "description": "Use the Singular Javascript Tag to track website events and collect web attribution data. Singular allows you to create standardized tracking links for web and mobile, and pulls ad spend and upstream data to report on ROAS for all of your channels. Page Visit events automatically include page URL and referrer (web_page_url, web_page_referrer) for raw data exports. For more information, please visit https://support.singular.net/hc/en-us.",
  "categories": [
    "ATTRIBUTION",
    "CONVERSIONS",
    "ADVERTISING"
...
[
  ...
  {
    "help": "The name of the Website that you are using Singular to track.",
    "enablingConditions": [
      {
        "paramName": "trackType",
        "type": "EQUALS",
  ...
  {
    "type": "RADIO",
    "name": "subDomainTrackingMode",
    "displayName": "Cross Sub-Domain Tracking Mode",
    "radioItems": [
      {
        "value": "simple",
        "displayValue": "Simple - Auto Persist using Cookies",
        "help": "Singular SDK will persist the Singular Device ID using a custom cookie. To use this option you must set the main domain you want to track.",
        "subParams": [
          {
            "type": "TEXT",
            "name": "domain",
            "displayName": "Main Tracking Domain",
            "simpleValueType": true,
            "help": "Provide the domain you want to track. If you want to track \"one.example.com\" and \"two.example.com\" please enter \"example.com\"",
            "valueHint": "yourdomain.con",
            "valueValidators": [
              {
                "type": "NON_EMPTY"
              }
      ...
      {
        "value": "advanced",
        "displayValue": "Advanced - Read Singular Device ID from GTM variable",
        "help": "The variable should contain an ID previously generated by Singular, in valid uuid4 format. You can persist this value across domains, e.g., using a top-level domain cookie or a server-side cookie.",
        "subParams": [
          {
            "type": "TEXT",
            "name": "singularDeviceId",
            "displayName": "Singular Device ID",
            "simpleValueType": true,
            "help": "The value in this variable should be an ID previously generated by Singular, and in valid uuid4 format. This variable should have a value before calling this tag.",
            "valueHint": "{{SINGULAR_ID_VARIABLE}}",
            "valueValidators": [
              {
                "type": "NON_EMPTY"
              }
